...
final class ChatListCell: UITableViewCell {
  ...
  lazy var userNickNameLabel = UIHelper.shared.createSingleLineLabel("이름")
  lazy var lastChatInfoLabel = UIHelper.shared.createSingleLineLabel("아직 채팅내역이 없어요.")
  lazy var lastChatTimeLabel = UIHelper.shared.createSingleLineLabel("")
  ...
  override func prepareForReuse() {
    ...
    writerProfileImageView.image = UIImage(named: "EmptyProfileImg")
  }
